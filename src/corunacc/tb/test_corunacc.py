...
# pytest test, in case you want to run using pytest instead of a Makefile
# also good if you want to run a batch of parameterised tests
...
def test_corunacc(request, if_count, ports_per_if, axis_pcie_data_width,
        axis_eth_data_width, axis_eth_sync_data_width, ptp_ts_enable):
